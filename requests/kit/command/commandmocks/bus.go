...
import (
	...
	command "github.com/diegodhdev/hexagonal-go-api/requests/kit/command"
...
func (_m *Bus) Dispatch(_a0 context.Context, _a1 command.Command) (any, error) {
	...
	return command.NewEmptyDataResponse(), r0
}
